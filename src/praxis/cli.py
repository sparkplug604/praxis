...
COMMANDS = {
    ...
    "authority": ("authority.py", "Manage authority anchors and adjudicate source-backed claims."),
    "governance": ("governance.py", "Manage Core governance checks, policy evaluations, and ledger receipts."),
